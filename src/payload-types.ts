...
export interface User {
  ...
  name?: string | null;
  /**
   * Controls admin panel access and what this person can change.
   */
  roles: ('admin' | 'editor' | 'sales' | 'customer')[];
  updatedAt: string;
  createdAt: string;
  email: string;
...
export interface Transaction {
  ...
  paystack?: {
    /**
     * The reference used to reconcile this payment in the Paystack dashboard.
     */
  ...
  /**
   * Where this order ships, captured at checkout.
   */
  shippingAddress?: {
    title?: string | null;
    firstName?: string | null;
